...
-- Issue: Similar to question 3, generated query returns the correct list of 1278 orders having multiple sel�ers, but did not do the last step of counting number of orders
-- Corrected query:
SELECT count(*) FROM
